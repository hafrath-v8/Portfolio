...
const Hero = () => {
  ...
  // WhatsApp URL handler for mobile vs desktop
  const getWhatsAppUrl = () => {
    const isMobile = /Mobi|Android/i.test(navigator.userAgent);
    const phone = "94704553604";
    const text = encodeURIComponent(
      "Hi Hafrath, I'm interested in working with you"
    );
    return isMobile
  ...
  return (
    <div className="min-h-screen overflow-hidden relative bg-white">
      ...
      {/* Menu Button */}
      <div className="fixed bg-white rounded-full p-2 shadow top-6 right-6 z-500">
      ...
      {/* Floating Top Icons */}
      <div className="absolute top-5 w-full flex justify-around lg:flex-col lg:absolute lg:left-[4%] z-10 pointer-events-none">
      ...
      {/* Main Content */}
      <div className="absolute overflow-hidden top-60 w-[1200px] lg:top-50 md:top-55 mx-auto z-0">
        <End />
      </div>
      ...
      <div className="flex flex-col items-center justify-center mt-[120px] text-center">
        ...
        <div className="flex w-full lg:flex-col justify-around lg:z-0 lg:absolute lg:left-[80%] pointer-events-none">
